...
import com.rushil.coincomet.databinding.FragmentDetailsBinding
...
class DetailFragment : Fragment() {
    ...
    private fun setButtonOnCLick(item: CryptoCurrency) {
        ...
        val clickListener = View.OnClickListener {
            when(it.id){
                fifteenMinute.id->loadChart(it,"15",item,oneDay,oneMonth,oneWeek,fourHour,oneHour)
                oneHour.id->loadChart(it,"1H",item,oneDay,oneMonth,oneWeek,fourHour,fifteenMinute)
                fourHour.id->loadChart(it,"4H",item,oneDay,oneMonth,oneWeek,fifteenMinute,oneHour)
                oneDay.id->loadChart(it,"D",item,fifteenMinute,oneMonth,oneWeek,fourHour,oneHour)
                oneWeek.id->loadChart(it,"W",item,oneDay,oneMonth,fifteenMinute,fourHour,oneHour)
                oneMonth.id->loadChart(it,"M",item,oneDay,fifteenMinute,oneWeek,fourHour,oneHour)
            }
        }
    ...
    private fun loadChart(
        ...
        binding.detaillChartWebView.loadUrl( "https://s.tradingview.com/widgetembed/?frameElementId=tradingview_76d87&symbol=" + item.symbol.toString()+
